<script lang="ts">
	...
	import { IconLayoutGrid as GridLayout, IconColumns1 as ColumnLayout } from '@tabler/icons-svelte';
...
<div class="relative h-10 w-full flex flex-col">
	...
	<div
		class="relative w-1/2 h-[2px] bg-black duration-200 ease-in-out {layout === ''
			? 'left-0'
			: 'left-1/2'}"
	></div>
</div>
